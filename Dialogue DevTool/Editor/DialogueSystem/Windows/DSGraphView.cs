    ...
    public class DSGraphView : GraphView
    {
        ...
        private IManipulator CreateNodeContextualMenu(string actionTitle, DSDialogueType dialogueType)
        {
            ContextualMenuManipulator contextualMenuManipulator = new ContextualMenuManipulator(
                menuEvent => menuEvent.menu.AppendAction(actionTitle, actionEvent => AddElement(CreateNode("DialogueName", "CharacterName", dialogueType, GetLocalMousePosition(actionEvent.eventInfo.localMousePosition))))
            );
        ...
        public DSNode CreateNode(string nodeName, string characterName, DSDialogueType dialogueType, Vector2 position, bool shouldDraw = true)
        {
            Type nodeType = Type.GetType($"DS.Elements.DS{dialogueType}Node");

            DSNode node = (DSNode) Activator.CreateInstance(nodeType);

            node.Initialize(nodeName, characterName, this, position);
        ...
        private void OnElementsDeleted()
        {
            deleteSelection = (operationName, askUser) =>
            {
                ...
                foreach (DSNode nodeToDelete in nodesToDelete)
                {
                    ...
                    nodeToDelete.DisconnetAllPorts();
        ...
        {
            this.AddStyleSheets(
                "Assets/Dialogue DevTool/Editor Default Resources/DialogueSystem/DSGraphViewStyles.uss",
                "Assets/Dialogue DevTool/Editor Default Resources/DialogueSystem/DSNodesStyles.uss"
            );
        }
