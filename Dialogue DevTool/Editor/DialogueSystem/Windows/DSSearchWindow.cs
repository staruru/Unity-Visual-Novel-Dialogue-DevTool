        ...
        public bool OnSelectEntry(SearchTreeEntry SearchTreeEntry, SearchWindowContext context)
        {
            ...
            switch (SearchTreeEntry.userData)
            {
                case DSDialogueType.SingleChoice:
                    {
                        DSSingleChoiceNode singleChoice = (DSSingleChoiceNode)_graphView.CreateNode("DialogueName", "CharacterName", DSDialogueType.SingleChoice, localMousePosition);
                        _graphView.AddElement(singleChoice);
                        return true;
                    }
                case DSDialogueType.MultipleChoice:
                    {
                        DSMultipleChoiceNode mutipleChoice = (DSMultipleChoiceNode)_graphView.CreateNode("DialogueName", "CharacterName", DSDialogueType.MultipleChoice, localMousePosition);
                        _graphView.AddElement(mutipleChoice);
                        return true;
                    }
                case Group _:
                    {
