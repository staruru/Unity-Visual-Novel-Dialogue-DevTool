...
namespace DS.Inspectors
{
    ...
    public class DSInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            DSDialogueContainerSO currentDialogueContainer =
            ...
            if (currentGroupedDialoguesFilter)
            {
                ...
                DSDialogueGroupSO dialogueGroup =
                    (DSDialogueGroupSO)dialogueGroupProperty.objectReferenceValue;

                dialogueNames = currentDialogueContainer.
                    GetGroupedDialogueNames(dialogueGroup, currentStartingDialoguesOnlyFilter);

                dialogueFolderPath += $"/Groups/{dialogueGroup.GroupName}/Dialogues";

                dialogueInfoMessage = "There are no" + (currentStartingDialoguesOnlyFilter ? " Starting" : "")
                    + " Dialogues in this Dialogue Group.";
            }
            else
            {
                dialogueNames = currentDialogueContainer.
                    GetUngroupedDialogueNames(currentStartingDialoguesOnlyFilter);
        ...
        private void DrawDialogueGroupArea(DSDialogueContainerSO dialogueContainer, List<string>
            dialogueGroupNames)
        {
            ...
            DSDialogueGroupSO selectedDialogueGroup = DSIOUtility.LoadAsset<DSDialogueGroupSO>
                ($"Assets/DialogueSystem/Dialogues/{dialogueContainer.FileName}/Groups/" +
                $"{selectedDialogueGroupName}", selectedDialogueGroupName);
        ...
        private void DrawDialogueArea(List<string> dialogueNames, string dialogueFolderPath)
        {
            ...
            UpdateIndexOnNamesListUpdate(dialogueNames, selectedDialogueIndexProperty,
                oldSelectedDialogueIndex, oldDialogueName, isOldDialogueNull);
            ...
            DSDialogueSO selectedDialogue = DSIOUtility.LoadAsset<DSDialogueSO>(dialogueFolderPath,
        ...
        private void StopDrawing(string reason, MessageType messageType = MessageType.Info)
        {
            ...
            DSInspectorUtility.DrawHelpBox("You need to select a Dialogue for this component to work " +
                "properly at Runtime!", MessageType.Warning);
